              ...
              {navigationItems.map((item) => (
                <div key={item.name} className="relative group">
                  <button
                    ...
                    className={`px-3 py-2 text-sm font-medium transition-all duration-200 relative flex items-center space-x-1 rounded-lg hover:bg-accent/50 ${
                    ...
                    >
                      {item.dropdown.map((dropdownItem) => (
                        <button
                          ...
                          className={`block w-full text-left px-4 py-2 text-sm transition-colors duration-150 rounded-lg mx-2 ${
